...
from fuo_xiami.provider import provider
...
with open('data/fixtures/artist_songs.json') as f:
    data_artist_songs = json.load(f)

with open('data/fixtures/playlist.json') as f:
    data_playlist = json.load(f)

with open('data/fixtures/user.json') as f:
    data_user = json.load(f)

with open('data/fixtures/user_playlists.json') as f:
